  ...
  return (
    <div className="space-y-8 animate-in fade-in-0 duration-500">
      ...
      <Card className="shadow-md">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-foreground">Manage Page Content</CardTitle>
          <CardDescription>Edit the content for key pages of your website.</CardDescription>
        </CardHeader>
          ...
          <Card className="flex flex-col">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="font-headline text-xl">Home Page</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="flex-grow">
              <p className="text-sm text-muted-foreground">Edit content for your main landing page.</p>
            </CardContent>
            <CardFooter>
          ...
          <Card className="flex flex-col">
            <CardHeader>
               <div className="flex items-center gap-3">
                ...
                <CardTitle className="font-headline text-xl">About Page</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="flex-grow">
          ...
          <Card className="flex flex-col">
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="font-headline text-xl">Contact Page</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="flex-grow">
      ...
      <Card className="shadow-md">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-2xl font-semibold text-foreground">Manage Projects</CardTitle>
