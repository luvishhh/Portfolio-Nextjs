...
export default function ProjectForm({ formAction, initialState, project, buttonText }: ProjectFormProps) {
  const fields = [
    ...
    { id: "year", label: "Year", type: "number", defaultValue: project?.year },
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <div className="flex items-center space-x-2">
        ...
        <Label htmlFor="featured" className="font-semibold text-sm">Featured Project</Label>
      </div>
